...
let originalBlock = document.querySelector('.wrap');


let clonedBlock = originalBlock.cloneNode(true);
clonedBlock.querySelector('p').textContent = "2 блок";
...
let coursesCreatedDiv = document.getElementById('courses_aditional');
...
// Проітерувати його, створиши для кожного об'єкту  масиву <div class='member'> та
// наповнити його данними з об'єкту.
...
simpsons.forEach(member =>{
    ...
    names.textContent = `${member.name} ${member.surname}`;
...
let ex6 = document.getElementById('courses_ex6');

exArray.forEach(course => {
    let courseDiv = document.createElement('div');
